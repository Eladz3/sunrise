  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
        ...
        <h2 className="mb-2 text-center text-lg font-semibold text-gray-900">Delete group?</h2>
        <p className="mb-6 text-center text-sm text-gray-500">
          <span className="font-medium text-gray-700">"{groupName}"</span> will be permanently deleted. This cannot be undone.
        </p>
        <div className="flex gap-3">
          <button onClick={onCancel} disabled={loading} className="flex-1 rounded-xl bg-gray-100 px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200 disabled:opacity-50">
            Cancel
          </button>

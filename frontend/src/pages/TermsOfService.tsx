  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-3xl px-6 py-10 leading-relaxed text-gray-900">
        ...
        <p className="mb-8 text-sm text-gray-500">Last updated: May 15, 2026</p>
        ...
        <section className="mb-8 rounded-lg border border-gray-200 bg-gray-50 px-5 py-4">
          ...
          <ol className="ml-5 list-decimal space-y-1 text-sm text-blue-700">
            {toc.map(({ id, label }) => (
              <li key={id}>
        ...
        <Section id="agreement" title="Agreement to Our Legal Terms">
          <p>
            We are <strong>ZeroToTen LLC</strong>, doing business as <strong>Sunrise</strong> ("Company," "we," "us," "our"), a company registered in California, United States, at 601 Van Ness Ave., Unit 3, San Francisco, CA 94102.
          </p>
          <p>
          ...
          <p>Sunrise is a social goal tracking platform that helps friends stay accountable, build habits, and achieve goals together.</p>
          <p>
          ...
          <p>These Legal Terms constitute a legally binding agreement made between you ("you") and ZeroToTen LLC, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
          <p>
        ...
        <Section id="ip" title="2. Intellectual Property Rights">
          <h3 className="mb-1 mt-3 font-semibold">Our intellectual property</h3>
          ...
          <h3 className="mb-1 mt-4 font-semibold">Your use of our Services</h3>
          ...
          <p>
            If you wish to make any other use of the Services, Content, or Marks, please address your request to{' '}
            <a href="mailto:elad.zohar3@gmail.com" className="text-blue-600 hover:underline">
              elad.zohar3@gmail.com
            </a>
            .
          ...
          <h3 className="mb-1 mt-4 font-semibold">Your submissions and contributions</h3>
          <p>
          ...
          <p>
            <strong>You are responsible for what you post or upload:</strong> By posting Contributions you confirm that they are original to you or that you have the necessary rights and licenses, and that they are not illegal, harassing, hateful, harmful, defamatory, obscene, or misleading. You are solely responsible for your Contributions and expressly agree to reimburse us for any losses we suffer because of your breach of this section or any third party's intellectual property rights.
          </p>
          <p>
        ...
        <Section id="purchases" title="5. Purchases and Payment">
          <p>We may offer paid features or subscriptions. If you make a purchase, you agree to provide current, complete, and accurate purchase and account information. You agree to promptly update account and payment information so we can complete your transactions and contact you as needed.</p>
          <p>We reserve the right to refuse any order. We may, in our sole discretion, limit or cancel quantities purchased per person, per household, or per order.</p>
          <p>All purchases are non-refundable except as required by applicable law or as expressly stated in a separate refund policy we may publish.</p>
        </Section>

        <Section id="prohibited" title="6. Prohibited Activities">
          <p>You may not access or use the Services for any purpose other than that for which we make them available. The Services may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us. As a user, you agree not to:</p>
          <ul className="ml-6 list-disc space-y-1.5">
        ...
        <Section id="ugc" title="7. User Generated Contributions">
          ...
          <p>Any Contributions you transmit may be treated as non-confidential and non-proprietary. When you create or make available any Contributions, you thereby represent and warrant that your Contributions do not violate the privacy or publicity rights of any third party, are not false, are not unsolicited advertising or spam, and do not violate applicable law.</p>
        </Section>
        ...
        <Section id="license" title="8. Contribution License">
          ...
          <p>We have the right, in our sole and absolute discretion, (1) to edit, redact, or otherwise change any Contributions; (2) to re-categorize any Contributions to place them in more appropriate locations on the Services; and (3) to pre-screen or delete any Contributions at any time and for any reason, without notice.</p>
        </Section>
        ...
        <Section id="copyrightyes" title="11. Copyright Infringements">
          ...
          <p>Please be advised that pursuant to applicable law you may be held liable for damages if you make material misrepresentations in a Notification. Thus, if you are not sure that material located on or linked to by the Services infringes your copyright, you should consider first contacting an attorney.</p>
        </Section>
        ...
        <Section id="modifications" title="13. Modifications and Interruptions">
          ...
          <p>We will not be liable to you or any third party for any modification, suspension, or discontinuance of the Services.</p>
          <p>We cannot guarantee the Services will be available at all times. We may experience hardware, software, or other problems or need to perform maintenance related to the Services, resulting in interruptions, delays, or errors. We reserve the right to change, revise, update, suspend, discontinue, or otherwise modify the Services at any time without notice to you.</p>
        </Section>

        <Section id="law" title="14. Governing Law">
          <p>These Legal Terms shall be governed by and defined following the laws of the State of California, United States. ZeroToTen LLC and yourself irrevocably consent that the courts of California shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
        </Section>
        ...
        <Section id="disputes" title="15. Dispute Resolution">
          ...
          <p>
            <strong>Binding Arbitration.</strong> If the parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved by binding arbitration in San Francisco, California. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association (AAA).
          </p>
          <p>
        ...
        <Section id="misc" title="23. Miscellaneous">
          ...
          <p>These Legal Terms operate to the fullest extent permissible by law. We may assign any or all of our rights and obligations to others at any time. We shall not be responsible or liable for any loss, damage, delay, or failure to act caused by any cause beyond our reasonable control.</p>
          <p>If any provision or part of a provision of these Legal Terms is determined to be unlawful, void, or unenforceable, that provision or part of the provision is deemed severable from these Legal Terms and does not affect the validity and enforceability of any remaining provisions.</p>
          <p>There is no joint venture, partnership, employment or agency relationship created between you and us as a result of these Legal Terms or use of the Services. You agree that these Legal Terms will not be construed against us by virtue of having drafted them.</p>
        </Section>

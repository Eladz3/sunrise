...
import { useCommunityGoals, groupGoalsByUser, calculateCommunityProgress } from '@/hooks/useCommunityGoals'
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-2xl bg-gradient-to-br from-sunrise-500 via-dawn-500 to-rose-500 p-6 text-white shadow-lg">
        <h1 className="mb-1 text-center text-2xl font-bold">Community Progress</h1>
      ...
      <section className="rounded-2xl bg-white p-4 shadow-sm">
        ...
        {goals.length === 0 && (
          <div className="py-12 text-center">
            ...
            <p className="mt-1 text-sm text-gray-400">Be the first to add a goal!</p>
          </div>
        )}
